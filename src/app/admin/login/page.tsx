        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-2.5 bg-emerald-600 hover:bg-emerald-700 disabled:bg-emerald-400 text-white font-medium rounded-lg text-sm transition-colors"
            >
              {loading ? 'جاري التسجيل...' : 'تسجيل الدخول / Login'}
            </button>
          </form>
        </div>
      </div>
